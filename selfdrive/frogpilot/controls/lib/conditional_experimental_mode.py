...
class ConditionalExperimentalMode:
  ...
  def stop_sign_and_light(self, lead_distance, modelData, standstill, v_ego, v_lead, frogpilot_toggles):
    ...
    model_check = len(modelData.orientation.x) == len(modelData.position.x) == ModelConstants.IDX_N or not standstill
    ...
    self.stop_light_mac.add_data(lead_check and model_check and model_filtered and model_stopping)
