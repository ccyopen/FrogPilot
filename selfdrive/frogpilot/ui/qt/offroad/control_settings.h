...
private:
  ...
  std::set<QString> standardPersonalityKeys = {"ResetStandardPersonality", "StandardFollow", "StandardJerkAcceleration", "StandardJerkSpeed"};
  std::set<QString> trafficPersonalityKeys = {"ResetTrafficPersonality", "TrafficFollow", "TrafficJerkAcceleration", "TrafficJerkSpeed"};
